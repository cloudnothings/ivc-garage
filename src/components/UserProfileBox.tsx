...
export default function UserProfileBox({ tabs, profile, socialPlatforms, cars }: UserProfileBoxProps) {
  return (
    <>
                      ...
                      <div className="mt-6 sm:flex sm:min-w-0 sm:flex-1 sm:items-center sm:justify-end sm:space-x-6 sm:pb-1">
                        ...
                        <div className="mt-6 justify-between flex flex-row mx-4 sm:space-x-4">
                          {socialPlatforms?.discord && (
                            <Link href={socialPlatforms.discord}>
                          ...
                          {socialPlatforms?.youtube && (<button type="button" data-mdb-ripple="true" data-mdb-ripple-color="light"
                            className="inline-block py-2.5 mb-2 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out" >
                          ...
                          {socialPlatforms?.tiktok && (<button type="button" data-mdb-ripple="true" data-mdb-ripple-color="light"
                            className="inline-block py-2.5 mb-2 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out" >
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-6 h-6">
                          ...
                          {socialPlatforms?.twitch && (<button type="button" data-mdb-ripple="true" data-mdb-ripple-color="light"
                            className="inline-block py-2.5 mb-2 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out" >
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-6 h-6">
                ...
                <div className="mx-auto mt-8 max-w-5xl px-4 pb-12 sm:px-6 lg:px-8">
                  ...
                  <div className="mt-1 grid grid-cols-1 gap-4 sm:grid-cols-2">
                    {cars && cars.map((car) => (
                      <div
                        key={car.id}
                        className="relative flex items-center space-x-3 rounded-lg border border-gray-500 px-6 py-5 shadow-sm focus-within:ring-2 focus-within:ring-white focus-within:ring-offset-2 hover:border-gray-400"
                      >
                        <div className="flex-shrink-0">
                          <img className="h-10 w-10 rounded-full" src={car.image} alt="" />
                        </div>
                        <div className="min-w-0 flex-1">
                          <a href="#" className="focus:outline-none">
                            <span className="absolute inset-0" aria-hidden="true" />
                            {car.nickname ? (<>
                              <p className="text-sm font-medium text-[#999999]">{car.nickname}</p>
                              <p className="truncate text-sm text-gray-500">{`${car.year} ${car.make} ${car.model}`}</p>
                            </>
                            ) : (
