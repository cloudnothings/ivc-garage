...
export const UserProfileBox = ({ tabs, profile, socialPlatforms, cars, user, discordId, setTabs }: UserProfileBoxProps) => {
                  ...
                  <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
                    <div className="-mt-12 sm:-mt-16 sm:flex sm:items-end sm:space-x-5">
                      ...
                      <div className="mt-6 sm:flex sm:min-w-0 sm:flex-1 sm:items-center sm:justify-end sm:space-x-6 sm:pb-1">
                        ...
                        {socialPlatforms && (
                          <SocialPlatformButtons socialPlatforms={socialPlatforms} discordId={discordId} />
                        )}
                      </div>
                    </div>
...
export const BuildCards = ({ cars }: BuildCardsProps) => {
  return (<>
    <div className="text-white font-medium text-md">Pinned Builds</div>
    <ul role="list" className="grid grid-cols-2 gap-x-4 gap-y-8 pt-2 sm:grid-cols-3 sm:gap-x-6 lg:grid-cols-4 xl:gap-x-8">
      {cars?.map((car) => (
        <li key={car.id} className="relative">
          <div className="group aspect-w-10 aspect-h-7 block w-full overflow-hidden rounded-lg">
            <img src={car.image} alt="" className="pointer-events-none object-cover group-hover:opacity-75" />
            <button type="button" className="absolute inset-0 focus:outline-none">
            </button>
          </div>
          <p className="pointer-events-none mt-2 block truncate text-sm font-medium text-white">{car.model}</p>
          <p className="pointer-events-none block text-sm font-medium text-[#999]">{car.year}</p>
        </li>
      ))}
    </ul>
  </>)
...
export const SocialPlatformButtons = ({ socialPlatforms, discordId }: SocialPlatformButtonProps) => {
  return (
    <>
      <div className="mt-6 justify-between flex flex-row mx-4 sm:space-x-4">
        {discordId && (
          <Link href={'https://discord.com/users/' + discordId}>
            <a type="button" data-mdb-ripple="true" data-mdb-ripple-color="light"
              target="_blank"
              className="inline-block py-2.5 mb-2 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out">
        ...
        {socialPlatforms?.github && (
          <Link href={'https://github.com/' + socialPlatforms.github}
          >
            <a type="button" data-mdb-ripple="true" data-mdb-ripple-color="light"
              target="_blank"
              className="inline-block py-2.5 mb-2 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out" >
        ...
        {socialPlatforms?.instagram && (
          <Link href={'https://instagram.com/' + socialPlatforms.instagram}>
            <a type="button" data-mdb-ripple="true" data-mdb-ripple-color="light"
              target="_blank"
              className="inline-block py-2.5 mb-2 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out" >
        ...
        {socialPlatforms?.linkedin && (
          <Link href={'https://linkedin.com/in/' + socialPlatforms.linkedin}>
            <a type="button" data-mdb-ripple="true" data-mdb-ripple-color="light"
              target="_blank"
              className="inline-block py-2.5 mb-2 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-6 h-6">
        ...
        {socialPlatforms?.youtube && (
          <Link href={'https://youtube.com/channel/' + socialPlatforms.youtube}>
            <a type="button" data-mdb-ripple="true" data-mdb-ripple-color="light"
              target="_blank"
              className="inline-block py-2.5 mb-2 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out" >
        ...
        {socialPlatforms?.tiktok && (
          <Link href={'https://tiktok.com/@' + socialPlatforms.tiktok}>
            <a type="button" data-mdb-ripple="true" data-mdb-ripple-color="light"
              target="_blank"
              className="inline-block py-2.5 mb-2 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out" >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-6 h-6">
        ...
        {socialPlatforms?.twitter && (
          <Link href={'https://twitter.com/' + socialPlatforms.twitter}>
            <a type="button" data-mdb-ripple="true" data-mdb-ripple-color="light"
              target="_blank"
              className="inline-block py-2.5 mb-2 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out">
        ...
        {socialPlatforms?.twitch && (
          <Link href={'https://twitch.tv/' + socialPlatforms.twitch}>
            <a type="button" data-mdb-ripple="true" data-mdb-ripple-color="light"
              target="_blank"
              className="inline-block py-2.5 mb-2 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out" >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-6 h-6">
        ...
        {socialPlatforms?.spotify && (
          <Link href={'https://open.spotify.com/user/' + socialPlatforms?.spotify}>
            <a type="button" data-mdb-ripple="true" data-mdb-ripple-color="light"
              target="_blank"
              className="inline-block py-2.5 mb-2 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out" >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-6 h-6">
